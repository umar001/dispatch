...
class Header extends React.Component {
  ...
  renderHeader = () => {
    ...
    // if (options) {
    //   return <Block center>{options ? this.renderOptions() : null}</Block>;
    // }
  };
  render() {
    const {
    ...
    //   transparent ? { backgroundColor: 'black' } : null,
    // ];

    // const navbarStyles = [styles.navbar, bgColor && { backgroundColor: 'black' }];
...
const styles = StyleSheet.create({
  ...
  categories: {
    height: height - theme.SIZES.BASE * 20,
